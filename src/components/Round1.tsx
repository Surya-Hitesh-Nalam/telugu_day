...
const Round1: React.FC<Round1Props> = ({ questions, onRoundComplete }) => {
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="text-center mb-8">
        <div className="inline-block px-6 py-3 bg-gradient-to-r from-orange-400 to-amber-400 rounded-full mb-4">
          <h2 className="text-2xl font-bold text-white">రౌండ్ 1</h2>
        </div>
        <h3 className="text-3xl font-bold text-amber-800 mb-2 bg-white bg-opacity-80 rounded-lg px-4 py-2 inline-block">Rapid Questions</h3>
        <p className="text-orange-600 text-lg bg-white bg-opacity-80 rounded-lg px-4 py-1 inline-block">వేగవంతమైన ప్రశ్నలు</p>
      </div>
      ...
      <div className="text-center">
        ...
        >
          {currentQuestion < questions.length - 1 ? 'Next Question' : 'Complete Round 1'}
